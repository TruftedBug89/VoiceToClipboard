...
`VoiceToClipboard-<ver>-portable.exe` in `dist/`. **Installers belong in GitHub Releases, not git** - never commit `dist/`, installers, blockmaps, or `latest.yml`. Only the maintainer publishes releases.
